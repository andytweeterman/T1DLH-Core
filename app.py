    ...
    if audio_hash != st.session_state.get("last_audio_hash"):
        ...
        with st.spinner("Processing Voice Dump and Correlating Telemetry..."):
            try:
                ...
                prompt = "The user just provided an audio brain dump. Listen to the audio and correlate their subjective state with their objective telemetry."
...
if st.session_state.active_view == "Daily Briefing":
    ...
    with st.spinner("Compiling Executive Briefing..."):
        try:
            ...
            prompt = f"""
            Write a daily briefing based on these metrics:
            - Day Type: {day_type}
